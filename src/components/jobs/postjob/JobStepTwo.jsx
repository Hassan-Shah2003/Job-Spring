    ...
    <div>
      ...
      <div className='mb-15'>
        <div className='mb-6'>
          ...
          <textarea className='border-2 border-gray-400 w-full p-4 mt-2 rounded-lg focus:ring-1 focus:outline-none focus:border-[#132e13]' placeholder='enter a name'>
          </textarea>
        </div>
        ...
        <div className=''>
          ...
          <div className='mb-6 flex'>
            <input className='border-2 border-gray-400 border-r-0 w-full p-4 rounded-l-lg focus:ring-1 focus:outline-none focus:border-[#132e13]' placeholder='enter a name'>
            </input>
